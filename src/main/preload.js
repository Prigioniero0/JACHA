...
contextBridge.exposeInMainWorld('electron', {
    ...
    // Packet Crafter
    packetSend: (options, onData, onExit) => {
        ipcRenderer.removeAllListeners('packet:data');
        ipcRenderer.removeAllListeners('packet:exit');
        ipcRenderer.on('packet:data', (_event, d) => onData(d));
        ipcRenderer.on('packet:exit', (_event, c) => onExit(c));
        ipcRenderer.send('packet:send', options);
    },
